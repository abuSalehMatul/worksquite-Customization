 ...
 */
class MemberStickyNoteController extends MemberBaseController
{
    ...
    public function index()
    {
        ...
        if(request()->ajax())
        {
            return   view('member.sticky-note.note-ajax', $this->data);

        }

        return view('member.sticky-note.index', $this->data);
    }
    ...
    public function create()
    {
        $this->noteDetail = [];
         ...
         return view('member.sticky-note.create-edit', $this->data);
    }
