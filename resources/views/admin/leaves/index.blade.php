...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12 m-b-10">
            <a href="{{ route('admin.leave.all-leaves') }}" class="btn btn-sm btn-success waves-effect waves-light pull-left">
        ...
        <div class="col-md-7">
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <a href="{{ route('admin.leaves.create') }}" class="btn btn-sm btn-success waves-effect waves-light  pull-right">
