            ...
            <div class="row">
                ...
                <div class="col-xs-12 ">
                    <div class="form-group">
                        ...
                        <input type="text" name="due_date" autocomplete="off" @if( $subTask->due_date) value="{{ $subTask->due_date->format('m/d/Y') }}" @endif id="due_date3" class="form-control datepicker">
                    </div>
                </div>
            </div>
        </div>
