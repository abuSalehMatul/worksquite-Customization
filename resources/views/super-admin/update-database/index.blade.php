...
@section('content')
    ...
    <div class="row">
        @if(isset($lastVersion))
            ...
            <div class="alert alert-info col-md-12">
                <div class="col-md-9"><i class="ti-gift"></i> @lang('modules.update.newUpdate') <label class="label label-success">{{ $lastVersion }}</label><br><br>
                ...
                <div class="col-md-3 text-center">
                    <a id="update-app" href="javascript:;" class="btn btn-success btn-small">@lang('modules.update.updateNow') <i class="fa fa-download"></i></a>
                    <br><br> OR <br><br>
                    <a href="{{ route('super-admin.update-settings.manual') }}" class="btn btn-inverse btn-small">@lang('modules.update.updateManual') <i class="fa fa-refresh"></i></a>
                </div>
    ...
    <p>
        ...
        │       └── Client allowed in multiple companies now.
        │       └── Bug fixes
        │
        ...
        │       └── Bug fixes
        │
        │   └── <strong>Version 2.5.5 & Version 2.5.6</strong>
        │       └── Admin billing bug fixes
        │
