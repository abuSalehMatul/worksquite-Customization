<html>
    ...
    <script>
        ...
        const envatoVerify = (purchaseCode) => {
            ...
            $('#response-message').html('<p class="bg-success" style="padding: 10px 5px; margin: 10px 0;">'+'success'/*data.message*/+' <a href="{{ \Illuminate\Support\Facades\URL::previous() }}">Click to go back</a></p>');
