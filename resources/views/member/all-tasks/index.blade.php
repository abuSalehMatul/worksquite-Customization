...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('member.all-tasks.data', [':startDate', ':endDate', ':hideCompleted', ':projectId']) !!}?clientID='+clientID +'&assignedBY='+ assignedBY+'&assignedTo='+ assignedTo+'&status='+ status+'&_token={{ csrf_token() }}';
