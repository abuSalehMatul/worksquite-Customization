...
Route::get('t',function(){
    return view('admin.task_pro.test');
});
Route::get('/test', 'TestController@tw');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        Route::group(
            ...
            Route::any('all-task/pro', 'ManageAllProTasksController@pro_index')->name('pro_task_board');
            Route::any('all-task/pro/ajx', 'ManageAllProTasksController@data');
            Route::any('all-task/pro/ajx/export/{startDate?}/{endDate?}/{projectId?}/{hideCompleted?}', 'ManageAllProTasksController@export')->name('all-tasks_pro.export');
            Route::any('all-task/pro/create_new', 'ManageAllProTasksController@create');
            Route::any('all-task/pro/save_task', 'ManageAllProTasksController@save_task')->name('pro_task_save');
            Route::any('all-task/pro/ajx/only_view','ManageAllProTasksController@only_view');
            Route::get('all-task/pro/ajx/change_position','ManageAllProTasksController@get_change_position');
            Route::get('all-task/pro/ajx/sub_to_task','ManageAllProTasksController@sub_to_task');
            Route::get('all-task/pro/ajx/change_num_record_to_show','ManageAllProTasksController@change_num_record_to_show');
            Route::get('all-task/pro/ajx/sub_to_parent_change','ManageAllProTasksController@sub_to_parent_change');
            Route::get('all-task/pro/ajx/showSubTaskForm', 'ManageAllProTasksController@showSubTaskForm');
            Route::get('all-task/pro/ajx/do_sort', 'ManageAllProTasksController@do_sort');
            Route::get('all-task/pro/ajx/showProjectForm', 'ManageAllProTasksController@showTaskForm');
            Route::get('all-task/pro/ajx/showColumn', 'ManageAllProTasksController@showColumn');
            Route::get('all-task/pro/ajx/getColumn', 'ManageAllProTasksController@returnColumnView');
            Route::any('all-task/pro/ajx/submitSubTaskForm', 'ManageAllProTasksController@post_subtask');
            Route::any('all-task/pro/ajx/search','ManageAllProTasksController@getSearchResult');
            Route::any('all-task/pro/ajx/search/getuser','ManageAllProTasksController@getSearchView');
            Route::any('all-task/pro/ajx/showTaskon', 'ManageAllProTasksController@showTaskon');
            Route::any('all-task/pro/ajx/hidecomplete', 'ManageAllProTasksController@hideComplete');
            Route::any('all-task/pro/ajx/change_group_by', 'ManageAllProTasksController@chagne_group_by');
            Route::any('all-task/pro/ajx/datesearcher', 'ManageAllProTasksController@datesearcher');
            Route::any('all-task/pro/ajx/tasksearcher_two', 'ManageAllProTasksController@tasksearcher_two');
            Route::any('all-task/pro/ajx/showFullView', 'ManageAllProTasksController@showFullView');
            Route::any('all-task/pro/ajx/quick_change_row','ManageAllProTasksController@quick_change');
            Route::any('all-task/pro/ajx/edit_single_row','ManageAllProTasksController@edit');
            Route::any('all-task/pro/edit_task', 'ManageAllProTasksController@update')->name('pro_task_edit');
            Route::any('all-task/pro/ajx/take_action', 'ManageAllProTasksController@take_action');
            Route::any('all-task/pro/ajx/recurrence', 'RecurrenceController@show_recurre');
            Route::any('all-task/pro/ajx/edit_recurrence','RecurrenceController@edit_recurrence');
            Route::any('all-task/pro/ajx/delete_recurrence', 'RecurrenceController@delete_recurrence');
            Route::any('all-task/pro/ajx/future_recurrence', 'RecurrenceController@future_recurrence');
            Route::post('all-task/pro/recurrence/save', 'RecurrenceController@recurrencesave');
        ...
        Route::get('leave/data/{startDate?}/{endDate?}/{employeeId?}', ['uses' => 'ManageLeavesController@data'])->name('leave.data');
...
Route::get('update-database', ['uses' => '\App\Http\Controllers\Front\HomeController@updateDatabase']);

Route::get('clear-cache', ['uses' => '\App\Http\Controllers\Front\HomeController@clearCache']);
Route::get('refresh-cache', ['uses' => '\App\Http\Controllers\Front\HomeController@refreshCache']);